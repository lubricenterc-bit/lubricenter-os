...
export function OrderWorkspace({ initialOrderId }: { initialOrderId?: string }) {
  ...
  return <div className="stack">
    ...
    {modal === "PARTIAL_CREDIT" && orderId && <PartialCreditSheet orderId={orderId} customer={customer} remainingVes={remainingVes} remainingRef={remainingRef} rates={rates} onDone={() => { setModal(null); router.push("/orders"); router.refresh(); }} onCancel={() => setModal(null)} />}
  </div>;
}
